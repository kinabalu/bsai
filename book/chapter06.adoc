...
// TODO for now. I think it's a matter of time before some of the tooling gets us more of the way there than we think
...
// TODO could? or already has. I think we're underexplaining the very dangers that already happen today.

// TODO it's Jackson Pollock.
...
// TODO I would use the California Consumer Privacy Act (CCPA) as the corollary to GDPR -- https://www.oag.ca.gov/privacy/ccpa
