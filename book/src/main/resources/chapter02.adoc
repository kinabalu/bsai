...
We can actually build a series of messages as our prompt, assigning the appropriate roles as we like. We could, for example, simulate a conversation about a Chinese Junk like so:
