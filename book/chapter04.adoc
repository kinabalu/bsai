...
////
TODO I feel like this is an awesome place to make some geeky Star Trek references, where the crew
shouted "COMPUTER! PLAY THE TAPE!" and stuff like that, and it spoke back to them.
////
...
// TODO what would it take to actually have an AI "sing?" How do people do this?

=== Transcription

// TODO "the more useful?" I mean... how do we know it's "more useful?" You might be right, but still...

// TODO very choppy paragraph here
